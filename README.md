...
class PayController extends Controller
{
    ...
    public function return()
    {
        ...
        return $pay->driver('alipay')->gateway()->verify($_GET);
    }
    ...
    public function notify()
    {
        ...
        if ($pay->driver('alipay')->gateway()->verify($_POST)) {
            ...
            file_put_contents(storage_path('notify.txt'), '订单号：' . $_POST['out_trade_no'] . "\r\n", FILE_APPEND);
            file_put_contents(storage_path('notify.txt'), '订单金额：' . $_POST['total_amount'] . "\r\n\r\n", FILE_APPEND);
        } else {
...
class PayController extends Controller
{
    ...
    public function notify()
    {
        ...
        $verify = $pay->driver('wechat')->gateway('mp')->verify($xml);
